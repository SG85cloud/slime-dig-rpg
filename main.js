...
class App {
    ...
    async loadAssets() {
        ...
        const assetPaths = {
            ...
            'frostite': 'assets/models/frostite-node.glb',
            'gold': 'assets/models/gold-node.glb',
            'obsidian': 'assets/models/obsidian-node.glb',
            'mithril': 'assets/models/mithril-node.glb',
            'sunstone': 'assets/models/sunstone-node.glb',
            'crawler': 'assets/models/mine-crawler.glb',
            'caveBat': 'assets/models/cave-bat.glb',
            'crystalStalker': 'assets/models/crystal-stalker.glb',
            'brute': 'assets/models/bone-brute.glb',
            'archer': 'assets/models/shadow-archer.glb',
            'voidWitch': 'assets/models/void-witch.glb',
            'magmaHound': 'assets/models/magma-hound.glb',
